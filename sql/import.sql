--------------------------------------------------------------------------------
--
-- sql firewall rule export/import
--
--
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- 
-- export sql firewall rules
-- 
--------------------------------------------------------------------------------
SELECT sql_firewall.export_rule('sql_firewall-rules.csv');
-- pg_sleep is radomly called so we ignore it here.
SELECT * FROM sql_firewall.all_rules WHERE query NOT LIKE '%pg_sleep%';

--
-- clear sql firewall rules
--
SELECT sql_firewall_reset();
-- pg_sleep is radomly called so we ignore it here.
SELECT * FROM sql_firewall.all_rules WHERE query NOT LIKE '%pg_sleep%';
...
--
-- import the exported rules above
--
SELECT sql_firewall.import_rule('sql_firewall-rules.csv');
-- pg_sleep is radomly called so we ignore it here.
SELECT * FROM sql_firewall.all_rules WHERE query NOT LIKE '%pg_sleep%';

-- 
-- verify the imported sql firewall rules works as expected on the following
-- test cases
-- 
